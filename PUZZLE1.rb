...
while opc != "n"
  ...
  begin
    ...
    if !MFRC522::Reader.picc_is_new_card_present
    ...
    # Lee la tarjeta
    if !MFRC522::Reader.picc_read_card_serial
    ...
    uid_hex = MFRC522::Reader.uid.map { |byte| byte.to_s(16).upcase.rjust(2, '0') }.join
    puts "\t YOUR UID IS:"
    puts "\t" + ">>>>>>>>>>".green
